...
@hydra.main(config_path="../configs", config_name="reparam.yaml")
def main(cfg):
    print(cfg.models.generator.name)
    ...
    torch.save(rep_state_dict, f"reparam_{cfg.models.generator.name}.pth")
