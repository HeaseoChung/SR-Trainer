...
class DWTForward(nn.Module):
    ...
    def forward(self, img1, img2):
        ...
        for j in range(self.J):
            ...
            ll1, high1 = lowlevel.AFB2D.apply(
                ll1, self.h0_col, self.h1_col, self.h0_row, self.h1_row, mode
            )
            yh1.append(high1)

            ll2, high2 = lowlevel.AFB2D.apply(
                ll2, self.h0_col, self.h1_col, self.h0_row, self.h1_row, mode
            )
            yh2.append(high2)

        for j in range(self.J):
            loss = F.l1_loss(yh1[j], yh2[j])
